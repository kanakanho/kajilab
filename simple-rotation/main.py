...
ex_host_matrix = host_to_client_affine_matrix @ client_matrix[0]

host_to_client_affine_matrix = rotation.rotation(
    client_matrix[0],
    ex_host_matrix,
    host_to_client_affine_matrix,
)
...
# ex_host_matrix = host_to_client_affine_matrix @ client_matrix[2]
...
browser.open_browser(
    np.array(
        [
            host_matrix[0].T,
            (np.linalg.inv(host_to_client_affine_matrix) @ client_matrix[0]).T,
            host_matrix[1].T,
            (np.linalg.inv(host_to_client_affine_matrix) @ client_matrix[1]).T,
            host_matrix[2].T,
            (np.linalg.inv(host_to_client_affine_matrix) @ client_matrix[2]).T,
        ]
    )
)
