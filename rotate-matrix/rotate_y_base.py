...
host_world_client_hand_arrows = [
    client_to_host_affine_matrix @ np.array([*arrow, 1])
    for arrow in client_right_arrows
]

print("host_world_client_hand_arrows")
print(host_world_client_hand_arrows)
...
#     interval=100,
# )
# ani.save("client_world_rotate_y_base変更前.gif", writer="pillow")
...
#     interval=100,
# )
# ani.save("client_world_rotate_y_base変更後.gif", writer="pillow")
...
theta_x = math.asin(client_world_host_hand_arrows_shift[2][0])
...
theta_y = math.asin(client_world_host_hand_arrows_shift[2][2])
...
theta_z = math.asin(client_world_host_hand_arrows_shift[2][1])
...
# アフィン行列を更新
host_to_client_affine_matrix = host_to_client_affine_matrix @ theta_x_rotation_matrix
host_to_client_affine_matrix = host_to_client_affine_matrix @ theta_y_rotation_matrix
# host_to_client_affine_matrix = host_to_client_affine_matrix @ theta_z_rotation_matrix
