...
def estimate_R_using_SVD(A: np.ndarray, A_prime: np.ndarray) -> np.ndarray:
    ...
    U, s, Vh = np.linalg.svd(N)  # 式 4.19
    V = Vh.T
    return V @ np.diag([1, 1, np.linalg.det(V @ U)]) @ U.T  # 式 4.27
...
host_right_cubes = [
    ...
    host_right_position + np.array([baius, 0, 0]),
    host_right_position + np.array([0, baius, 0]),
    host_right_position + np.array([0, 0, baius]),
]
...
# client_right_cubes[0] からそれ以外の点までの辺をプロット
for i in range(1, len(client_right_cubes)):
    ax.plot(
        [client_right_cubes[0][0], client_right_cubes[i][0]],
        [client_right_cubes[0][1], client_right_cubes[i][1]],
        [client_right_cubes[0][2], client_right_cubes[i][2]],
        color="red",
        alpha=0.2,
    )
...
# client_world_host_hand_cubes[0] からそれ以外の点までの辺をプロット
for i in range(1, len(client_world_host_hand_cubes)):
    ax.plot(
        [client_world_host_hand_cubes[0][0], client_world_host_hand_cubes[i][0]],
        [client_world_host_hand_cubes[0][1], client_world_host_hand_cubes[i][1]],
        [client_world_host_hand_cubes[0][2], client_world_host_hand_cubes[i][2]],
        color="blue",
        alpha=0.2,
    )
...
#     interval=100,
# )
# ani.save("client_world_変更前.gif", writer="pillow")
...
# host_right_cubes[0] からそれ以外の点までの辺をプロット
for i in range(1, len(host_right_cubes)):
    ax.plot(
        [host_right_cubes[0][0], host_right_cubes[i][0]],
        [host_right_cubes[0][1], host_right_cubes[i][1]],
        [host_right_cubes[0][2], host_right_cubes[i][2]],
        color="red",
        alpha=0.2,
    )
...
# host_world_client_hand_cubes[0] からそれ以外の点までの辺をプロット
for i in range(1, len(host_world_client_hand_cubes)):
    ax.plot(
        [
            host_world_client_hand_cubes[0][0],
            host_world_client_hand_cubes[i][0],
        ],
        [
            host_world_client_hand_cubes[0][1],
            host_world_client_hand_cubes[i][1],
        ],
        [
            host_world_client_hand_cubes[0][2],
...
client_positon_shift = client_world_host_hand_cubes[0][:3] - client_right_cubes[0][:3]
client_world_host_hand_cubes_shift = [
    cube[:3] - client_positon_shift for cube in client_world_host_hand_cubes
]

print("client_right_cubes")
print(client_right_cubes)
print("client_world_host_hand_cubes_shift")
print(client_world_host_hand_cubes_shift)

# Convert lists to NumPy arrays for element-wise subtraction
estimated_R_client = estimate_R_using_SVD(
    np.array([cube[:3] for cube in client_right_cubes]),
    np.array([cube[:3] for cube in client_world_host_hand_cubes_shift]),
)
print("estimated_R_client")
print(estimated_R_client)

host_position_shift = host_world_client_hand_cubes[0][:3] - host_right_cubes[0][:3]
host_world_client_hand_cubes_shift = [
    cube[:3] - host_position_shift for cube in host_world_client_hand_cubes
]

estimated_R_host = estimate_R_using_SVD(
    np.array([cube[:3] for cube in host_right_cubes]),
    np.array([cube[:3] for cube in host_world_client_hand_cubes_shift]),
)
print("estimated_R_host")
print(estimated_R_host)

host_to_client_affine_matrix[:3, :3] = estimated_R_client

print("new_host_to_client_affine_matrix")
print(host_to_client_affine_matrix)

client_to_host_affine_matrix[:3, :3] = estimated_R_host
print("new_client_to_host_affine_matrix")
print(client_to_host_affine_matrix)
...
for i in range(1, len(client_world_host_hand_cubes)):
    ax.plot(
        [
            client_world_host_hand_cubes[0][0],
            client_world_host_hand_cubes[i][0],
        ],
        [
            client_world_host_hand_cubes[0][1],
            client_world_host_hand_cubes[i][1],
        ],
        [
            client_world_host_hand_cubes[0][2],
...
#     interval=100,
# )
# ani.save("client_world_変更後.gif", writer="pillow")
...
#     interval=100,
# )
# ani.save("client_world_2回変更後.gif", writer="pillow")
...
#     interval=100,
# )
# ani.save("client_world_3回変更後.gif", writer="pillow")
...
#     interval=100,
# )
# ani.save("client_world_4回変更後.gif", writer="pillow")
...
ani.save("client_world_5回変更後.gif", writer="pillow")
